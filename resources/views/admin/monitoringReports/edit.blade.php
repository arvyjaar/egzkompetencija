...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.monitoringReport.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.monitoring-reports.update", [$monitoringReport->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="form-group {{ $errors->has('observer') ? 'has-error' : '' }}">
                <label for="observer">{{ trans('cruds.monitoringReport.fields.observer') }}*</label>
                <input type="text" id="observer" name="observer" class="form-control" value="{{ old('observer', isset($monitoringReport) ? $monitoringReport->observer : '') }}" required>
            ...
            <div class="form-group {{ $errors->has('branch') ? 'has-error' : '' }}">
                ...
                <input type="text" id="branch" name="branch" class="form-control" value="{{ old('branch', isset($monitoringReport) ? $monitoringReport->branch : '') }}" required>
            ...
            <div class="form-group {{ $errors->has('category') ? 'has-error' : '' }}">
                ...
                <input type="text" id="category" name="category" class="form-control" value="{{ old('category', isset($monitoringReport) ? $monitoringReport->category : '') }}" required>
            ...
            <div class="form-group {{ $errors->has('observing_type') ? 'has-error' : '' }}">
                ...
                @foreach(App\MonitoringReport::OBSERVING_TYPE_RADIO as $key => $label)
                    <div>
                        <input id="observing_type_{{ $key }}" name="observing_type" type="radio" value="{{ $key }}" {{ old('observing_type', $monitoringReport->observing_type) === (string)$key ? 'checked' : '' }} required>
