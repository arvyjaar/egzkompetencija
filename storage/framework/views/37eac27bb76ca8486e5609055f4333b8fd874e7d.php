...
<div class="card">
    <div class="card-header">
        <i class="far fa-edit"></i> <?php echo e(trans('cruds.form.title_singular')); ?>

    </div>

    <div class="card-body">
        <form action="<?php echo e(route("admin.forms.update", [$form->id])); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            <div class="form-group <?php echo e($errors->has('title') ? 'has-error' : ''); ?>">
                <label for="title"><?php echo e(trans('cruds.form.title')); ?>*</label>
            ...
            <div class="form-group <?php echo e($errors->has('worktype_id') ? 'has-error' : ''); ?>">
                ...
                <select name="worktype_id" id="worktype_id" class="form-control select2" required>
                    ...
                    <option value="<?php echo e($id); ?>" <?php echo e(old('worktype_id', $form->worktype_id) == $id ? 'selected' : ''); ?>>
                        <?php echo e($title); ?>
            ...
            <div class="form-group <?php echo e($errors->has('active') ? 'has-error' : ''); ?>">
                <div class="icheck-primary icheck-inline">
                    <input type="checkbox" name="active" id="active" value="1"
                        <?php echo e(old('active', $form->active) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/egzkomp.test/resources/views/admin/forms/edit.blade.php ENDPATH**/ ?>