...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-1">
                <span <?php if(in_array($evaluation->assessment_value, $evaluation->criterionWithTrashed->assessment->bad_values)): ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/egzkomp.test/resources/views/admin/reports/show-new.blade.php ENDPATH**/ ?>