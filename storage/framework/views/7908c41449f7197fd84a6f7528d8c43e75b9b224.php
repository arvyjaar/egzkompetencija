	...
	<body class="sidebar-mini layout-fixed" style="height: auto">
		<div class="wrapper">
			<nav class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
				...
				<!-- Right navbar links -->
				<span
					>Prisijungęs: <i><?php echo e(auth()->user()->name); ?></i></span
				>
			</nav>
				...
				var i,
						...
						(u = (function () {
							...
							return (
								...
								(n.prototype.toggle = function () {
									this._setMargin(),
										i('body').hasClass(c) || i('body').hasClass(f) ? this.show() : this.collapse();
								}),
					...
					ae =
						...
						E(document).on('click', j.TOGGLE_BUTTON, function (e) {
							...
							'pushmenu' !== E(t).data('widget') && (t = E(t).closest(j.TOGGLE_BUTTON)),
									...
									return this.each(function () {
										...
										e || ((e = new n(X(this), e)), X(this).data(F, 'string' == typeof t ? e : t)),
											'string' == typeof t && t.match(/remove|toggle/)
												? e[t]()
												: 'object' === ('undefined' == typeof t ? 'undefined' : ne(t)) &&
												  e._init(X(this));
									});
								}),
								n
...
<?php /**PATH /home/vagrant/egzkomp.test/resources/views/layouts/admin.blade.php ENDPATH**/ ?>