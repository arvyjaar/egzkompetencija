...
<div class="card">
    ...
    <div class="card-body">
        <form action="<?php echo e(route("admin.criteria.store")); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group <?php echo e($errors->has('competency_id') ? 'has-error' : ''); ?>">
                <label for="competency_id"><?php echo e(trans('cruds.competency.title')); ?>*</label>
                ...
                <select name="competency_id" id="competency_id" class="form-control select2" required>
                    ...
                    <option value="<?php echo e($competency->id); ?>" 
                        <?php echo e(old('competency_id') == $competency->id ? 'selected' : ''); ?> > 
                        <?php echo e($competency->title); ?> (<?php echo e($competency->worktype->title); ?>)
                    </option>
            ...
            <div class="form-group <?php echo e($errors->has('assessment_type_id') ? 'has-error' : ''); ?>">
                ...
                <select name="assessment_type_id" id="assessment_type_id" class="form-control" >
                    ...
                    <option value="<?php echo e($assessment_type->id); ?>" 
                        <?php echo e(old('assessment_type_id') == $assessment_type->id ? 'selected' : ''); ?> > 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/egzkomp.test/resources/views/admin/criteria/create.blade.php ENDPATH**/ ?>