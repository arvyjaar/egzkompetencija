...
<div class="card">
    <div class="card-header">
        <?php echo e(trans('global.add' )); ?> <?php echo e(trans('cruds.competency.title_singular' )); ?>

    </div>

    <div class="card-body">
        <form action="<?php echo e(route("admin.competencies.store")); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group <?php echo e($errors->has('worktype_id') ? 'has-error' : ''); ?>">
                ...
                <select name="worktype_id" id="worktype_id" class="form-control select2" required>
                    ...
                    <option value="<?php echo e($id); ?>" 
                        <?php echo e(old('worktype_id') == $id ? 'selected' : ''); ?> > 
                        <?php echo e($title); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/egzkomp.test/resources/views/admin/competencies/create.blade.php ENDPATH**/ ?>